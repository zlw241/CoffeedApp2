...
class SearchListView(LocationListView):
	def get_queryset(self):
		...
		return coremodels.Locations.objects.filter(title__icontains=incoming_query_string)
...
class LocationDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
    	...
    	location = coremodels.Locations.objects.get(id=self.kwargs['pk'])
...
class ReviewCreateView(CreateView):
	...
	def form_valid(self, form):
		...
		form.instance.location = coremodels.Locations.objects.get(id=self.kwargs['pk'])
